...
public class AppiumInteractiveExceptionBuilderImpl implements IInteractiveElementExceptionBuilder {
  ...
  protected <T extends Throwable> T clearStacktrace(T ex) {
    ...
    if (ArrayUtils.isNotEmpty(stacktraceWhitelist)) {
      ...
      for (StackTraceElement element : trace) {
        ...
        if ((StringUtils.startsWith(className, "ru.bspb.arma") || StringUtils.startsWithAny(
            className, stacktraceWhitelist))
            && !StringUtils.startsWith(className, "ru.bspb.arma.aspects")
