...
public class AppWebElementProvider extends WebElementProvider {
  ...
  WebElement findElement(@Nullable WebElement context, @NonNull String locator) {
    IOSDriver<IOSElement> driver = (IOSDriver<IOSElement>) webDriverFactory.getDriver();
    if (context == null) {
  ...
  WebElement findElement(@Nullable WebElement context, @NonNull String locator, int index) {
    IOSDriver<MobileElement> driver = (IOSDriver<MobileElement>) webDriverFactory.getDriver();
