...
public class AndroidAppCapabilitiesProviderImpl implements ICapabilitiesProvider {
  ...
  private static final String DEFAULT_CAPABILITIES_FILE = "/android_app_capabilities.properties";
